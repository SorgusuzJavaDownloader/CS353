...
public class Controllers {
	...
	/*@RequestMapping(value = "/SubmitReview",params = "CompanyName", method = RequestMethod.POST)
	public String submitReviews2(@RequestParam String CompanyName, Model model) throws SQLException {
		if(user != null) {
			return postInterviewReview(CompanyName, model);
		}
		else
			return Service.initPage();
